...
GUI::ECS::Online::Bullet::Bullet(const GUI::ECS::Components::SpriteComponent &sprite, const bool fromEnemy, const std::pair<int, int> &positionInitial, const unsigned int speed, const std::pair<int, int> &direction, const int damage)
...
GUI::ECS::Online::Bullet::Bullet(const std::uint32_t EntityId, const GUI::ECS::Components::SpriteComponent &sprite, const bool fromEnemy, const std::pair<int, int> &positionInitial, const unsigned int speed, const std::pair<int, int> &direction, const int damage)
...
GUI::ECS::Online::Bullet::Bullet(const std::uint32_t EntityId, const GUI::ECS::Online::Bullet &bullet)
    : EntityNode(EntityId)
{
    update(bullet);
};
...
const std::string GUI::ECS::Online::Bullet::getInfo(const unsigned int indent) const
{
...
void GUI::ECS::Online::Bullet::_createBullet(const std::pair<int, int> &positionInitial)
{
...
std::ostream &GUI::ECS::Online::operator<<(std::ostream &os, const GUI::ECS::Online::Bullet &item)
{
    os << item.getInfo();
    return os;
}
