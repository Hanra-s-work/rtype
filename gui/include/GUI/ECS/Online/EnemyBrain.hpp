 ...
 *
 * @details This file contains the definition of the EnemyBrain class, which is part of the ECS (Entity-Component-System) architecture in the Online namespace.
    ...
    namespace ECS
    {
        namespace Online
        {
            ...
            class EnemyBrain : public EntityNode {
                 ...
                 */
                EnemyBrain(const GUI::ECS::Online::EnemyBrain &copy);
                 ...
                 * @param copy The EnemyBrain instance to copy.
                 */
                EnemyBrain(const std::uint32_t entityId, const GUI::ECS::Online::EnemyBrain &copy);
                ...
                /**
                 * @brief Make the enemy shoot a projectile with a defined id
                 *
                 * @param id The id of the projectile
                 *
                 * @return const GUI::ECS::Online::Bullet The projectile.
                 */
                ...
                long int _health = 3;                                           //!< The health of the enemy.
                unsigned int _delayBeforeShot = 20;                             //!< The delay before the enemy can shoot.
                GUI::ECS::Online::Bullet _bullet;                               //!< The bullet associated with the enemy.
