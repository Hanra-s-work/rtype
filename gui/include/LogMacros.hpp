 ...
 */
    ...
    #ifndef _PRETTY_LOG
        #define _PRETTY_LOG
        #define PRETTY_DEBUG    Log::getInstance() << RESET_COL << BACKGROUND_COL << DEBUG_COL    << _DEBUG_STR    << RESET_COL << BACKGROUND_COL << DEFAULT_FG  << _MY_FILE_GETTER      //!< Debug log with details and colour.
        #define PRETTY_SUCCESS  Log::getInstance() << RESET_COL << BACKGROUND_COL << SUCCESS_COL  << _SUCCESS_STR  << RESET_COL << BACKGROUND_COL << DEFAULT_FG  << _MY_FILE_GETTER      //!< Success log with details and colour.
        #define PRETTY_INFO     Log::getInstance() << RESET_COL << BACKGROUND_COL << INFO_COL     << _INFO_STR     << RESET_COL << BACKGROUND_COL << DEFAULT_FG  << _MY_FILE_GETTER      //!< Info log with details and colour.
        #define PRETTY_WARNING  Log::getInstance() << RESET_COL << BACKGROUND_COL << WARNING_COL  << _WARNING_STR  << RESET_COL << BACKGROUND_COL << DEFAULT_FG  << _MY_FILE_GETTER      //!< Warning log with details and colour.
        #define PRETTY_ERROR    Log::getInstance() << RESET_COL << BACKGROUND_COL << ERROR_COL    << _ERROR_STR    << RESET_COL << BACKGROUND_COL << DEFAULT_FG  << _MY_FILE_GETTER      //!< Error log with details and colour.
        #define PRETTY_CRITICAL Log::getInstance() << RESET_COL << BACKGROUND_COL << CRITICAL_COL << _CRITICAL_STR << RESET_COL << BACKGROUND_COL << DEFAULT_FG  << _MY_FILE_GETTER      //!< Critical log with details and colour.
    #endif
    /** @note } */
